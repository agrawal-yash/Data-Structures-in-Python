# -*- coding: utf-8 -*-
"""
Created on Mon May  9 23:32:05 2022
...
# Retrieve Maximum Value from stack in constant time
# instead of individual items, you push tuples on stack 
# with each item having the max value of the stack as the 2nd value
...
class Stack :
    ...
    def push(self, data):
        ...
        self.stack.append((data, max(data, self.getMax())))
